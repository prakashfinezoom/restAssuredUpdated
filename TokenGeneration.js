    ...
    it('Token Generation', () => {
        ...
        return request
            ...
            .then((res) => {
                ...
                assert.typeOf(res.body.refresh_token_expires_in,'number')
                ...
                expect(res.body.token_type).length(6)
                expect(res.body.issued_at).length(13)
                expect(res.body.access_token).length(28)
                expect(res.body.application_name).length(36)
                expect(res.body.scope).length(0)
                expect(res.body.refresh_count).length(1)
                expect(res.body.status).length(8)
